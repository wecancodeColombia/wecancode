...
<html>
    ...
    <body>
        ...
        <div id="area_trabajo" style="  margin: 20px auto; width: 800px; font-family: 'Montserrat', sans-serif; letter-spacing: -1px; ">
            ...
            <div style=" padding-left: 10px; font-weight: 700; letter-spacing: -2px;  height: 50px; background-color: rgb(231,76,60); color:  white; font-size: 37px;  line-height: 50px;">
            ...
            <div style="  font-weight: 700; letter-spacing: -2px;  height: 100px;  color:  white; font-size: 37px;  line-height: 50px; ">

                <img style=" padding: 10px;" src="http://c1.neweggimages.com/BizIntell/item/14/127/14-127-832/pro_101414.png" width="100" >
                <img style=" padding: 10px;" src="http://c1.neweggimages.com/BizIntell/item/14/127/14-127-832/pro_101414.png" width="100" height="100" >
                <img style=" padding: 10px;" src="http://mco-s2-p.mlstatic.com/combo-board-socket-1156-intel-i3-540-memoria-2gb-842111-MCO20495044282_112015-F.jpg" width="100" height="100" >
                <img style=" padding: 10px;" src="http://c1.neweggimages.com/BizIntell/item/14/127/14-127-832/pro_101414.png" width="100" >
                <img style=" padding: 10px;" src="http://c1.neweggimages.com/BizIntell/item/14/127/14-127-832/pro_101414.png" width="100" height="100" >
                <img style=" padding: 10px;" src="http://mco-s2-p.mlstatic.com/combo-board-socket-1156-intel-i3-540-memoria-2gb-842111-MCO20495044282_112015-F.jpg" width="100" height="100" >
        ...
        <div class="fb-comments" data-href="http://developers.facebook.com/docs/plugins/comments/" data-width="800" data-numposts="5"></div>
        <div id="pie"></div>
    </body>
</html>
