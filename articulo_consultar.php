        ...
        <div style=" height: 500px; width: 800px; margin-top: 10px;">
            ...
            <div style=" margin-top: 10px;">
                ...
                <div style="width: 380px; height: 405px; float: left; padding-left: 10px; padding-right: 5px; font-size: 15px;">
                    ...
                    <div class="fb-like" style=""></div>
                    <div style=" margin-top: 5px;">
                        <img src="imagenes/logo_facebook.png" width="32" height="32" alt="icono_facebook"/>
                        <img src="imagenes/logo_instagram.png" width="32" height="32" alt="icono_facebook"/>
                        <img src="imagenes/logo_mercadolibre.png" width="32" height="32" alt="icono_facebook"/>
                        <img src="imagenes/logo_whatsapp.png" width="32" height="32" alt="icono_facebook"/>
                        <img src="imagenes/logo_gmail.png" width="32" height="32" alt="icono_facebook"/>
                    </div>
                </div>
            </div>
        </div>
